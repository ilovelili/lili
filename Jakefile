...
var kDistFilename = 'samatha.js';
var kDistMinFilename = 'samatha.min.js';
...
desc('Concatenates all files into dist/samantha[.min].js');
task('build', doBuild, { async: true });

// Concatenates and minifies the files
desc('Concatenates and minifies all files into dist/samantha.min.js');
